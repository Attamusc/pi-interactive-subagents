...
describe("subagent discovery", () => {
  ...
  it("preserves ordered skill authority in the launch policy", () => {
    assert.deepEqual(testApi.createLaunchPolicySeed({
      agent: "worker",
      deniedTools: new Set(["subagent"]),
      cwd: "/work/project",
      agentDir: "/work/agent",
      systemPrompt: null,
      requestedSkills: ["review", "lint"],
    }), {
      version: 2,
      agent: "worker",
